...
# draw contour
result = img.copy()
cv2.drawContours(result, [big_contour], -1, (0,0,255), 10)

# write results to disk
cv2.imwrite("blob_threshold.jpg", thresh)
cv2.imwrite("blob_blob.jpg", blob)
cv2.imwrite("blob_contour.jpg", result)
